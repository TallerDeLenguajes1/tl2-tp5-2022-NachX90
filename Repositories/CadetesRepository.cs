...
public class CadetesRepository : IDBRepository<Empleado>
{
    ...
    public void Alta(Empleado Objeto)
    {
        try
        {
            ...
            _logger.LogInformation($"Se cargó el cadete {Id}.");
        }
    ...
    public void BajaLogica(int Id)
    {
        try
        {
            ...
            _logger.LogInformation($"Se eliminó el cadete {Id}.");
        }
        catch (SQLiteException SQLiteEx)
        {
    ...
    public void Modificacion(Empleado Objeto)
    {
        try
        {
            ...
            _logger.LogInformation($"Se modificó el cadete {Objeto.Id}.");
        }
        catch (SQLiteException SQLiteEx)
        {
    ...
    public Empleado ObtenerPorID(int Id)
    {
        try
        {
            ...
            _logger.LogInformation($"Se solicitó el cadete {Id}.");
            return Objeto;
        }
        catch (SQLiteException SQLiteEx)
        {
    ...
    public List<Empleado> ObtenerTodos()
    {
        try
        {
            ...
            _logger.LogInformation($"Se solicitaron todos los cadetes.");
