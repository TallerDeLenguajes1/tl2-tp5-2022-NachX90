...
public class EmpleadosRepository : IEmpleadosRepository
{
    ...
    public void Alta(Empleado Objeto)
    {
        try
        {
            ...
            _logger.LogInformation($"Se cargó el empleado {Id}.");
        }
    ...
    public void BajaLogica(int Id)
    {
        try
        {
            ...
            _logger.LogInformation($"Se eliminó el empleado {Id}.");
        }
        catch (SQLiteException SQLiteEx)
        {
    ...
    public void Modificacion(Empleado Objeto)
    {
        try
        {
            ...
            _logger.LogInformation($"Se modificó el empleado {Objeto.Id}.");
        }
        catch (SQLiteException SQLiteEx)
        {
    ...
    public Empleado ObtenerPorID(int Id)
    {
        try
        {
            ...
            _logger.LogInformation($"Se solicitó el empleado {Id}.");
            return Objeto;
        }
        catch (SQLiteException SQLiteEx)
        {
    ...
    public List<Empleado> ObtenerTodos()
    {
        try
        {
            ...
            _logger.LogInformation($"Se solicitaron todos los empleados.");
